// AutoGeneratedHeader — DO NOT REMOVE! Must be on the FIRST line to enable auto-generation. Remove only if you want to disable auto-generated headers for this script.
